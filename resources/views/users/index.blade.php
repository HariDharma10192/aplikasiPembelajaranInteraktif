    ...
    <div class="row gap-5">
        <div class="col-12 col-md-4 col-lg-2">
            <div class="d-flex flex-column gap-1 w-100">
                ...
                <div><a href="/petunjuk" class="btn btn-success w-100 text-center sidebar-btn"><i class="fas fa-info-circle"></i> Petunjuk</a></div>
                <div><a href="/users/laporan" class="btn btn-success w-100 text-center sidebar-btn"><i class="fas fa-file-alt"></i> Laporan</a></div>
