    ...
    <div class="col-12 col-md-4 col-lg-3">
        <div class="sidebar-container">
            <div class="d-flex flex-column gap-1 w-100">
                <a href="/admin/users" class="btn btn-warning w-100 text-center sidebar-btn"><i class="fas fa-users"></i>Kelola Users</a>
                <a href="/admin/materi" class="btn btn-success w-100 text-center sidebar-btn"><i class="fas fa-book"></i>Kelola Materi</a>
                <a href="/admin/quis" class="btn btn-info w-100 text-center sidebar-btn"><i class="fas fa-question-circle"></i>Kelola Quis</a>
                <a href="/admin/quis/evaluasi" class="btn btn-primary w-100 text-center sidebar-btn"><i class="fas fa-chart-bar"></i>Kelola Evaluasi</a>
                <a href="/admin/petunjuk" class="btn btn-secondary w-100 text-center sidebar-btn"><i class="fas fa-info-circle"></i>Petunjuk</a>
                <a href="/admin/laporan" class="btn btn-dark w-100 text-center sidebar-btn"><i class="fas fa-file-alt"></i>Laporan</a>
